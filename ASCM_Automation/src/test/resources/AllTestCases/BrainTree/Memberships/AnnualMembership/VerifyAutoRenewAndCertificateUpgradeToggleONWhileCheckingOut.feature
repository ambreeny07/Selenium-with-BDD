Feature: Verify-auto-renew-and-certificate-upgrade-toggle-ON-while-checking-out
  Scenario: Verify-auto-renew-and-certificate-upgrade-toggle-ON-while-checking-out
